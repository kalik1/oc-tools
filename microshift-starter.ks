...
network --bootproto=static --ip=10.90.11.62 --netmask=255.255.255.0 --gateway=10.90.11.1 --nameserver=10.90.11.1 --device=link --activate --onboot=on --hostname=microshift-starter --noipv6
